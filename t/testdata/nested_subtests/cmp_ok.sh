...
subtest() {
        tap_pass
        tap_cmp_ok "abc" "=" "def" "Subtest Unequal strings" \
                "$0" "${LINENO:-""}"
        tap_cmp_ok 1 "-gt" 2 "Subtest Unordered numbers" "$0" \
                "${LINENO:-""}"
        tap_cmp_ok 1 "-le" 1 "Subtest Ordered numbers" "$0" \
                "${LINENO:-""}"
        tap_cmp_ok 1 "-ne" 1 "Subtest Equal numbers" "$0"

        subtest() {
                tap_pass
                tap_cmp_ok "abc" "=" "def" "Subsubtest Unequal strings" \
                        "$0" "${LINENO:-""}"
                tap_cmp_ok 1 "-gt" 2 "Subsubtest Unordered numbers" \
                        "$0" "${LINENO:-""}"
                tap_cmp_ok 1 "-le" 1 "Subsubtest Ordered numbers" \
                        "$0" "${LINENO:-""}"
