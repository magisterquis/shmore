...
[`tap_done_testing`](./src/plan.subr#L76) | Emit a plan if `tap_plan` wasn't called or check if the correct number of tests were run if so
[`tap_reset`](./src/plan.subr#L47)        | Reset Shmore's internal state
